...
const Summarizer = () => {
  ...
  async function handleSummarize(e: React.FormEvent) {
    ...
    try {
      ...
      const documentContext = documentText ? `\n\nAdditional Document Context:\n${documentText}\n\nPlease incorporate this document content into the summary as appropriate.` : '';
      
      const prompt = `You are an expert legal document summarizer. Provide concise, accurate summaries of legal documents following Indian legal standards.${documentContext}\n\nLANGUAGE: ${langStr}\n\nDocument to summarize:\n${input}\n\nPlease provide a clear summary without markdown formatting.`;
