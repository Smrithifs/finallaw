...
Provide only the translation without additional explanations.`;
      ...
      // Clean result: remove markdown asterisks for user-friendly output
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Button variant="secondary" onClick={() => setShowUploader(true)} className="flex items-center gap-2"><Upload className="w-4 h-4" /> Upload Document</Button>
              </div>
              {showUploader && (
                <div className="mt-2">
                  <DocumentUploader onDocumentProcessed={handleDocumentUploaded} onClose={() => setShowUploader(false)} />
                </div>
              )}
              <textarea
                value={sourceText}
