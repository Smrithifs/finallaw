...
const SectionExplainer = () => {
  ...
  const handleExplain = async () => {
    ...
    setIsLoading(true);
    try {
      const documentContext = documentText ? `\n\nAdditional Document Context:\n${documentText}\n\nPlease analyze this document in relation to the section being explained.` : '';
...
Explain Section ${sectionNumber} of the ${actName} in detail.${documentContext} Structure your response as follows:
            ...
            <div>
              ...
              {documentText && (
                <div className="mt-2 p-3 bg-gray-50 rounded-md">
                  <p className="text-sm text-gray-600">Document uploaded successfully. Content will be analyzed along with the section.</p>
                </div>
              )}
            </div>
